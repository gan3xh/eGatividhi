...
.botton .front span {
  ...
  <body>
    ...
    <button class="botton" id="create-project-btn">
  ...
  <div class="card-header">
    <div class="text-header">Project Registration</div>
  </div>
  <div class="card-body">
    <form id="project-form" class="hidden" method="POST">
      <div class="form-group">
        <label for="projectId">Project ID:</label>
        <input type="number" id="projectId" name="project_id" min="1" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" id="subSector" name="sub_sector">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="project_contractor">Contractor:</label>
        <input type="text" id="project_contractor" name="project_contractor">
      </div>
      <div class="form-group">
        <label for="totalCost">Total Cost (Rs):</label>
        <input type="text" id="totalCost" name="total_cost" required>
      </div>
